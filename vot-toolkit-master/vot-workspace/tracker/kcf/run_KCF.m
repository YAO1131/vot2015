...
% function [precision, fps] = run_KCF(video, kernel_type, feature_type, show_visualization, show_plots)
% function results = run_KCF(video, kernel_type, feature_type, show_visualization, show_plots)
